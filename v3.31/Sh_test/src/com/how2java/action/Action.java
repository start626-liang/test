...
public class Action {
    ...
    public <T> T get(int id, String type) {
    	T result = null;
        ...
        if("java".equals(type)){
        	result = (T) s.get(Product_java.class, id);
        }
        else if("sql".equals(type)){
        	result = (T) s.get(Product_sql.class, id);
        }
        else if("other".equals(type)){
        	result = (T) s.get(Product_other.class, id);
        }
        else if("message".equals(type)){
        	result = (T) s.get(Message.class, id);
        }
        else{
    ...
    public int getId(String name, String content, String date) {
        ...
        Query q = s.createQuery("from Product p where p.name=? and p.content=? and p.date=?");
    ...
    public void delete(int id, String type) {
        ...
        if("java".equals(type)){
	        ...
	        int id1 = new Action().getId(p.getName(), p.getContent(), p.getDate());
	        
	        Product p1 = (Product) s.get(Product.class, id1);
    ...
    public <T> void update(T o, String typeName) {

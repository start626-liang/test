				...
				<div class="span7">
					...
					<div>		 	
					 	<form action="saveMessage" method="post" id="message">
							<p>昵称：<input class="text" id="name" type="text" name="message.name" value=""  size="110"  max="30"  maxlength="25" placeholder="请填写" required /></p>
							    
							 <p>内容：<textarea class="text" id="content" name="message.content" rows="20" wrap="hard"  maxlength="800" placeholder="请填写" required></textarea></p>
							 <p>

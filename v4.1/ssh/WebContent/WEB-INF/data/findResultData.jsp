			...
			<div class="row-fluid">
			 ...
			 <div class="lg_accordion">
			  ...
			  <div class="lg_accordion">
				...
				<div class="span7">
					${transmitStringA}
					<s:iterator value="datas" var="d">
						<ul class="iterator">
								<li class="start">
									<a href="showProduct?product.id=${d.id}&type=main">
										<strong class="n">${d.name}</strong>
									</a>
								</li>
								<li class="start">分类：${d.type}&nbsp;&nbsp;&nbsp;日期：${p.date}</li>
								<li class="start" id="il">${d.content}</li>
						</ul>
						<br />
					</s:iterator>
				</div>

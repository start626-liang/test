			  ...
			  <div class="lg_accordion">
				...
				<div class="span7">
					<form action="saveData" method="post">
						...
						<p>名称：<input class="text" type="text" id="name" name="data.name" maxlength="240"  placeholder="请填写"  required /></p>
						    
						 <p>内容：<textarea class="text" id="content" name="data.content" rows="20"  maxlength="800000" wrap="hard" placeholder="请填写" required></textarea></p>
						 <p>
...
<script src="js/jquery-1.8.3.min.js"></script>
	...
	$(function(){
		...
		function valName(){
			...
			if(str2.length > 240){
				str2.substring(0,240);
				document.getElementById("name").innerHTML = str2;
				alert("名称不得超出240个字");
				return false;
			}
			else if(str3.length > 800000){
				str3.substring(0,800000);
